package softuni.OOP.working_with_abstraction.JediGalaxy;
...
public class Main {
    public static void main(String[] args) {
        ...
        int[] dimestions = Arrays.stream(scan.nextLine().split(" ")).mapToInt(Integer::parseInt).toArray();
        ...
        while (!"Let the Force be with you".equals(command = scan.nextLine())) {
            ...
            int[] evilCoordinates = Arrays.stream(scan.nextLine().split(" ")).mapToInt(Integer::parseInt).toArray();
